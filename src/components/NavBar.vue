    ...
    <nav class="shadow-lg shadow-black/30 bg-primary/50 backdrop-blur-md border-b border-white/10 fixed w-full h-14 sm:h-auto duration-300 text-sm z-50 flex items-center justify-center">
        ...
        <ul class="hidden flex-col h-full items-center justify-center text-xl gap-4 text-white mobile-nav">
            ...
            <li class="cursor-pointer">
                <router-link role="button" to="/dyslexia" class="mobile-nav-link nav-links cursor-pointer">Dyslexia</router-link>
            </li>
        ...
        <div :class="['hidden sm:flex items-center justify-between px-7 gap-8 text-white/85 font-light mx-auto w-full nav-content', isScrolled ? 'py-2' : 'py-4']">
            <ul class="items-center gap-8 flex">
                ...
                <li>
                    <router-link role="button" to="/dyslexia"
                        class="relative after:absolute after:bg-white after:bottom-[-4px] after:left-0 after:h-[2px] after:w-0 hover:after:w-full after:transition-all after:duration-300">Dyslexia</router-link>
                </li>
                <li>
