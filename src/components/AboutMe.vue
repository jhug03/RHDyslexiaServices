<template>
    <div class="bg-secondary p-5 md:p-10 flex flex-col sm:flex-row items-start justify-center max-w-5xl mt-10 mx-4 sm:mx-auto gap-8 rounded-2xl"
        id="qualifications">
        ...
        <div class="text-white">
            <h1 class="uppercase md:text-4xl text-2xl">Dyslexia Services & Assessments for Children and
                Young adults</h1>
            ...
            <p class="font-extralight mt-4 text-sm sm:text-base">I have been a qualified primary school teacher for over
                ...
                primary school. I am a <strong class="italic">qualified specialist</strong> teacher and <strong
                    class="italic">assessor</strong> of <strong class="italic">dyslexia</strong>. I am
